...
public:
    ...
    QCheckBox *normalRenderCheckBox;
    QCheckBox* overclockRenderingCheckBox;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        normalRenderCheckBox = new QCheckBox(verticalWidget);
        normalRenderCheckBox->setObjectName("normalRenderCheckBox");

        verticalLayout->addWidget(normalRenderCheckBox);

        overclockRenderingCheckBox = new QCheckBox(verticalWidget);
        overclockRenderingCheckBox->setObjectName("overclockRenderingCheckBox");

        verticalLayout->addWidget(overclockRenderingCheckBox);
...
"(Fl\303\244chengewichtung)", nullptr));
        ...
        normalRenderCheckBox->setText(QCoreApplication::translate("MainWindow", "Normalen rendern", nullptr));
        overclockRenderingCheckBox->setText(QCoreApplication::translate("MainWindow", "Immediate Mod ausreizen", nullptr));
